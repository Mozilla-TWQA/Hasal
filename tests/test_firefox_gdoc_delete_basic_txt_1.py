...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.test_url, self.test_url_id = self.target_helper.clone_target("1o7zKj0oUYj0hyC_jKxVJOcCuy4xcf0cUiA4Jac-zqZk",
    ...
    def test_firefox_gdoc_delete_basic_txt_1(self):
