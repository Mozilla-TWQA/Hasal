...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.test_url, self.test_url_id = self.target_helper.clone_target("1ptpg3mlsWbWJRN-W6TFSLJxaWI9XY7N6axeVxmaZTCI",
    ...
    def test_firefox_gdoc_read_basic_txt_1(self):
