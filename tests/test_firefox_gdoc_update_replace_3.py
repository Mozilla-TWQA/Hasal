...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.test_url, self.test_url_id = self.target_helper.clone_target(self.env.TEST_TARGET_ID_3_PAGE_CONTENT_WITH_TXT_TABLE_IMAGE,
                                                                          self.env.output_name)

    def test_firefox_gdoc_update_replace_3(self):
