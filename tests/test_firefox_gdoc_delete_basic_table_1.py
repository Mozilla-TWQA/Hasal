...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.test_url, self.test_url_id = self.target_helper.clone_target(self.env.TEST_TARGET_ID_1_PAGE_CONTENT_WITH_TABLE,
                                                                          self.env.output_name)

    def test_firefox_gdoc_delete_basic_table_1(self):
