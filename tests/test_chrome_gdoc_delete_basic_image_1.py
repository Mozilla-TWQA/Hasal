...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.test_url, self.test_url_id = self.target_helper.clone_target("1JFLaWO-X2upQcYvPQBT59VQJmHngai9u7K3WPG1ll6Y",
    ...
    def test_chrome_gdoc_delete_basic_image_1(self):
