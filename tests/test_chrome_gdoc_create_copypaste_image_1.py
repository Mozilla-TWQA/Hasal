...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.test_url, self.test_url_id = self.target_helper.clone_target("1zSZRnZA8LsXcj29nuyd7xya9M5VcClKdFEOOx2cSVyU",
    ...
    def test_chrome_gdoc_create_copypaste_image_1(self):
