...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        self.set_variable(test_target=self.global_config['gsheet-1000r-number-enchar-1000formula'])
        self.set_variable(target_folder=self.global_config['gsuite']['gsheet-test-target-folder-uri'])
        super(TestSikuli, self).setUp()

    def test_chrome_gsheet_1000r_number_chars_1000formula_deletecell(self):
