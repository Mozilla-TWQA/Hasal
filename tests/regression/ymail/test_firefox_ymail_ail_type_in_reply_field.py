...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.set_configs(self.config_name.INDEX,
                         self.extract_platform_dep_settings({'win32': {'7': {'compare-threshold': 0.04},
                                                                       '10': {'compare-threshold': 0.04}}}))

    def test_firefox_ymail_ail_type_in_reply_field(self):
        self.test_url = self.global_config['yahoo']['mail-url']
