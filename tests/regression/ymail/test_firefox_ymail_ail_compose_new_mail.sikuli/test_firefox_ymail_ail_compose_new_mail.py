...
class Case(basecase.SikuliInputLatencyCase):
    ...
    def run(self):
        ...
        compare_area = self.tuning_region(obj, x_offset=190, y_offset=130, w_offset=600, h_offset=490)
        self.set_override_region_settings(customized_region_name, compare_area)

        # Record T1, and capture the snapshot image
        # Input Latency Action
        loc, screenshot, t1 = app.il_click_compose_btn(capture_width, capture_height)
