...
class TestSikuli(PerfBaseTest):
    ...
    def test_firefox_gsearch_ail_select_search_suggestion(self):
        self.round_status = self.sikuli.run_test(self.env.test_name, self.env.output_name, test_target=self.env.TEST_GOOGLE_SEARCH_ENGLISH,
