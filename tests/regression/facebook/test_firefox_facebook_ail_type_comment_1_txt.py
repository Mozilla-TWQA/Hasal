...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.set_configs(self.config_name.INDEX, self.extract_platform_dep_settings({"win32": {"default": {"compare-threshold": 0.003}}}))

    def test_firefox_facebook_ail_type_comment_1_txt(self):
