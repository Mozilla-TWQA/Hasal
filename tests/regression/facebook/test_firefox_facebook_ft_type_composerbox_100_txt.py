...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.set_configs(self.config_name.INDEX, self.extract_platform_dep_settings({"win32": {"7": {"mismatch-rate-threshold": 0.005}}}))

    def test_firefox_facebook_ft_type_composerbox_100_txt(self):
