...
class Case(basecase.SikuliInputLatencyCase):
    ...
    def run(self):
        ...
        loc, screenshot, t1 = fb._il_click('[log] Mouse Click - Button Up', fb.FACEBOOK_CHAT_TAB_CLOSE_BUTTON, capture_width, capture_height, wait_component=fb.FACEBOOK_CHAT_TAB_CLOSE_BUTTON)
        sleep(0.1)
        t2 = time.time()
