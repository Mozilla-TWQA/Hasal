...
class TestSikuli(PerfBaseTest):
    ...
    def setUp(self):
        ...
        self.test_url, self.test_url_id = self.target_helper.clone_target("10bLI9mQ3v5oq441FlZW93w0Or1fvXTasWl4m3nFLzFo",
    ...
    def test_chrome_gdoc_read_basic_image_1(self):
