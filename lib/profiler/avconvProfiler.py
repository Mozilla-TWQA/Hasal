...
class AvconvProfiler(BaseProfiler):
    ...
    def __init__(self, input_env, input_index_config, input_exec_config, input_browser_type=None, input_sikuli_obj=None):
        super(AvconvProfiler, self).__init__(input_env, input_index_config, input_exec_config, input_browser_type, input_sikuli_obj)
        self.process = None
        self.fh = None
        self.t1_time = None
