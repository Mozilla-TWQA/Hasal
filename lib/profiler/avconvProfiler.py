...
class AvconvProfiler(BaseProfiler):
    ...
    def start_recording(self):
        ...
        if platform.system().lower() == "windows":
            self.process = subprocess.Popen("ffmpeg -f gdigrab -draw_mouse 0 -framerate 90 -video_size 1024*768 -i desktop -c:v libx264 -preset veryfast -g 15 -crf 0 " + self.env.video_output_fp)
        else:
