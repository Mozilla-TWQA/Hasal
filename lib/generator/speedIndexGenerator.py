from runTimeDctGenerator import RunTimeDctGenerator
...
class SpeedIndexGenerator(object):
    ...
    DEFAULT_DCTRUNTIME_GENERATOR_NAME = RunTimeDctGenerator.__class__.__name__

    @staticmethod
    def generate_sample_result(input_generator_name, input_sample_dict, input_sample_index):
        return RunTimeDctGenerator.generate_sample_result(input_generator_name, input_sample_dict, input_sample_index)
    ...
    def generate_result(self, input_data, input_global_result):
        ...
        if SpeedIndexGenerator.DEFAULT_DCTRUNTIME_GENERATOR_NAME in input_global_result:
            ...
            objdctruntimegenerator = RunTimeDctGenerator()
